...
class FullEchoProtocol(BasicProcess):
    def __init__(self):
        super().__init__(
            num_plates=num_source + num_dest,
            process_name="FullEchoProcess",
        )
    ...
    def process(self):
        protocol_path = "~/workspace/devices/uppsala/echo/sila_server/tests/test_data/echo_fixed_dmso_V2_compounds_only.csv"
